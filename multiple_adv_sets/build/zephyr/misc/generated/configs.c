...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_EXT_ADV_MAX_ADV_SET, 64);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DIS_PNP_PID, 0xEEF1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DEVICE_APPEARANCE, 512);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ADV_SET, 64);
